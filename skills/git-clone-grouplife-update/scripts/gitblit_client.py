#!/usr/bin/env python3
"""Fetch a page from the internal Gitblit web UI using a saved session
(see ~/.config/gitblit-web/credentials.json, created separately, outside
this skill folder since it is mirrored to a public GitHub repo).
